...
object Config {
    operator fun get(key: String): String? {
        // 优先读取原名，如果没有，尝试读取带 magisk. 前缀的名字
        val v = (props[key] ?: props["magisk.$key"]) as? String ?: return null
        return v.ifBlank { null }
    }

    fun contains(key: String) = get(key) != null

    val version: String get() = get("version") ?: "30.7"
    val versionCode: Int get() = get("versionCode")?.toInt() ?: 30700
    val stubVersion: String get() = get("stubVersion") ?: "30700"
    val abiList: List<String> get() = get("abiList")?.split(",") ?: listOf("arm64-v8a", "armeabi-v7a", "x86", "x86_64")
}
